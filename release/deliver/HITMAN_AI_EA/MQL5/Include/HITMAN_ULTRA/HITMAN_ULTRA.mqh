#ifndef HITMAN_ULTRA_MASTER_MQH
#define HITMAN_ULTRA_MASTER_MQH
//+------------------------------------------------------------------+
//| HITMAN AI — MASTER BLUEPRINT — full architecture modules         |
//+------------------------------------------------------------------+

#include "00_Types.mqh"
#include "31_Inputs.mqh"
