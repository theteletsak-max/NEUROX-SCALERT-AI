#ifndef SNIPER_AI_ULTRA_16_AI_CORE_MQH
#define SNIPER_AI_ULTRA_16_AI_CORE_MQH
//+------------------------------------------------------------------+
...
void EvaluateStrategySignals(bool &buySignal, bool &sellSignal, string &strategyTag)
{
   ...
   // OK94 LIVE: SNIPER AI ULTRA complete architecture decision flow
   UltraSnap snap;
...
#endif // SNIPER_AI_ULTRA_16_AI_CORE_MQH
