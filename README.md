...
Use **[`SNIPER_AI_OK45.mq5`](SNIPER_AI_OK45.mq5)**  
`BUILD_ID: SA_PRISM_SIGNAL_OK_45`

1. Close MetaEditor
2. **File → Open Data Folder** → `MQL5/Experts/`
3. **Delete** any old `Sniper*` / `SNIPER*` `.mq5` / `.ex5` files
4. Copy **`SNIPER_AI_OK45.mq5`**
5. Open it, confirm `SA_PRISM_SIGNAL_OK_45`, compile **(F7)**
...
**OK45 signal OK:** Cont same-direction BOS + SMT directional sweeps. Rev polarity correct. Quality + ladder + defense + harden retained.
