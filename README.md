...
Use **[`SNIPER_AI_OK17.mq5`](SNIPER_AI_OK17.mq5)**  
`BUILD_ID: SA_AGGRESSIVE_SNIPER_17`

1. Close MetaEditor
2. **File → Open Data Folder** → `MQL5/Experts/`
3. **Delete** any old `Sniper*` / `SNIPER*` `.mq5` / `.ex5` files
4. Copy **`SNIPER_AI_OK17.mq5`**
5. Open it, confirm `SA_AGGRESSIVE_SNIPER_17`, compile **(F7)**
6. Attach to chart → enable **Algo Trading**
7. Keep **AggressiveSniperEntries** / **NeverBlockValidSniperEntry** enabled (defaults)
