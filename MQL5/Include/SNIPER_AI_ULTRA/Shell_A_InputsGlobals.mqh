#ifndef SNIPER_AI_ULTRA_SHELL_A_MQH
#define SNIPER_AI_ULTRA_SHELL_A_MQH
//+------------------------------------------------------------------+
...
// OK94: PRIME inputs replaced — see ULTRA CORE / MARKET / FIB / STRATEGIES inputs in ULTRA module.
...
// --- OK94 early decls for modular includes ---
input bool EnableMultiSymbolTrading = false;
input int  MultiSymbolTimerSeconds  = 15;
input bool EnableDashboard = true;   // OK94 modular: early decl for Dashboard module
