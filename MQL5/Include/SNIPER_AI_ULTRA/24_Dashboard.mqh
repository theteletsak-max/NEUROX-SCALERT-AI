#ifndef SNIPER_AI_ULTRA_24_DASHBOARD_MQH
#define SNIPER_AI_ULTRA_24_DASHBOARD_MQH
//+------------------------------------------------------------------+
...
string UltraDashboardText(const string s)
{
   ...
   return
      "======= SNIPER AI ULTRA 00-30 =======\n" +
      "BUILD: SA_ULTRA_94 | Comment: SNIPER AI\n" +
...
#endif // SNIPER_AI_ULTRA_24_DASHBOARD_MQH
